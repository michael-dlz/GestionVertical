...
export default function About() {
  return (
    <>
      ...
      <div className="">
        <div className="py-40">
          <div className="flex gap-28 items-center 2xl:max-w-7xl max-w-6xl mx-auto">
      ...
      <div className="bg-lightGray text-center py-40">
        <div className="2xl:max-w-7xl max-w-6xl mx-auto">
          ...
          <ul className="list-disc text-left text-textBlackp">
            <li className="mb-4"><b>Cumplimiento legal:</b> Compromiso de cumplir con todas las leyes y regulacionesrelevantes que afectan a la administración de edificios, incluyendo leyes de propiedad,seguridad, salud ocupacional, protección ambiental, etc.</li>
            <li className="mb-4"><b>Ética empresarial:</b> Fomento de una cultura empresarial ética, que promueva lahonestidad, la integridad y el comportamiento responsable en todas las operaciones yrelaciones comerciales.</li>
            <li className="mb-4"><b>Prevención de conflictos de interés:</b> Establecemos comopolítica yprocedimiento paraidentificar, divulgar y manejar adecuadamente cualquier conflicto de interés que puedasurgir entre los intereses personales y los intereses de la empresa, comunicaciónmediante correo electrónico, previa a las contrataciones.</li>
            <li className="mb-4"><b>Lucha contra la corrupción y el soborno:</b> Compromiso de no participar en prácticascorruptas, sobornos o cualquier otra forma de conducta antiética en las relaciones comerciales.</li>
            <li className="mb-4"><b>Protección de datos y privacidad:</b> Compromiso de proteger la información confidencialde los clientes, empleados y otras partes interesadas, cumpliendo con las leyes deprivacidad y protección de datos correspondientes.</li>
            <li className="mb-4"><b>Transparencia financiera:</b> Mantenimiento de registros financieros precisos y transparentes, y divulgación adecuada de información financiera según sea necesario.</li>
            <li className="mb-4"><b>Capacitación y concientización:</b> Proporcionar capacitación regular a los empleadossobre las políticas de compliance de la empresa, así como también crear conciencia sobrela importancia del cumplimiento ético y legal en todas las actividades laborales.</li>
            <li className="mb-4"><b>Monitoreo y cumplimiento:</b> Establecimiento de mecanismos de monitoreo y auditoríapara garantizar el cumplimiento continuo de las políticas de compliance y laidentificación temprana de cualquier desviación o incumplimiento.</li>
            <li className="mb-4"><b>Reporte y respuesta a infracciones:</b> Establecimiento de procedimientos para reportar yresponder a cualquier infracción o violación de las políticas de compliance, incluyendo laimplementación de medidas disciplinarias apropiadas cuando sea necesario.</li>
          </ul>
        </div>
      </div>
    </>
