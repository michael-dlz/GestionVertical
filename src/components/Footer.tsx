    ...
    return (
        <>
            <div className="bg-primary pt-28 pb-4">
                <div className="grid grid-cols-4 max-lg:grid-cols-2 max-md:grid-cols-1 gap-20 max-w-7xl max-lg:mx-5 mx-auto text-white pb-20">
                ...
                <div className="flex gap-20 max-w-7xl max-lg:mx-5 mx-auto text-white font-medium text-sm pt-8 my-8 border-slate-600 border-t-2 items-center justify-between">
                    <div className="">
