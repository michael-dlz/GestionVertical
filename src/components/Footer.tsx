...
export default function Footer() {
    ...
    const linksStyle = "font-extralight text-sm max-2xl:text-xs"
        ...
        <>
            <div className="bg-primary pt-28 pb-4">
                <div className="grid grid-cols-4 max-lg:grid-cols-2 max-md:grid-cols-1 gap-20 2xl:max-w-6xl max-w-5xl max-lg:mx-5 mx-auto text-white pb-20">
                    ...
                    <div className={blockStyle}>
                        <h2 className="font-bold text-base max-2xl:text-xs">NOTICIAS</h2>
                        <div className="flex flex-col gap-2">
                            <p className="font-extralight text-sm max-2xl:text-xs">Obtén nuestras últimas novedades directamente a tu correo.</p>
                            <div className="flex my-5 rounded-sm overflow-hidden">
                                <input className="w-full h-full py-4 px-3 bg-inputColor text-textBlackp max-2xl:text-xs" type="text" placeholder="Correo Electrónico" />
                                <button className="py-4 px-3 bg-secondary hover:shadow-2xl"><IconSend size={25} /></button>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="flex gap-20 2xl:max-w-6xl max-w-5xl max-lg:mx-5 mx-auto text-white font-extralight text-sm max-2xl:text-xs pt-8 my-8 border-slate-600 border-t-2 items-center justify-between">
                    <div className="">
