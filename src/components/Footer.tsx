    ...
    return (
        <>
            <div className="bg-primary pt-28 pb-4">
                ...
                <div className="flex gap-20 2xl:max-w-7xl max-w-5xl max-lg:mx-5 mx-auto text-white font-medium text-sm pt-8 my-8 border-slate-600 border-t-2 items-center justify-between">
                    <div className="">
