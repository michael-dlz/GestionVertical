        ...
        <>
            <div className="p-10 border rounded-2xl" id={titleWork}>
                ...
                <div className="flex pb-5 border-b gap-2">
                    <a href={`https://wa.me/+51942901570?text=Hola,%20Estoy%20Interesado%20en%20el%20puesto%20de%20${encodeURIComponent(titleWork)}`} className="bg-secondary w-auto text-white py-4 px-8 rounded-sm text-sm hover:shadow-2xl flex justify-center items-center  gap-1"><IconCV stroke="#fff" size={20} />Postular</a>
                    <button
