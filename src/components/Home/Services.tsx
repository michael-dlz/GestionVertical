...
export function Services() {
    ...
    return (
        <>
        <div className="bg-gradient-to-br from-primary to-secondary h-auto py-40">
                <div className="2xl:max-w-7xl max-w-5xl mx-auto max-lg:mx-5">
                    <div className="pb-20 flex flex-col items-start justify-center gap-8 text-wrap">
                        <div className="flex gap-1 text-xs">
                            <span className="bg-lightSecondary text-secondary w-auto px-6 py-1 rounded-lg border border-secondary">PAQUETES DE SERVICIOS</span>
                        </div>
