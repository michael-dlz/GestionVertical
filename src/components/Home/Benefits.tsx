            ...
            <div className="h-auto py-40">
                <div className="2xl:max-w-6xl max-w-5xl mx-auto">
                    <div className="flex gap-1 text-xs text-center justify-center pb-8">
                        <span className="bg-ligthSpan text-spanColor w-auto px-6 py-1 rounded-sm font-semibold !font-sans">BENEFICIOS</span>
                    </div>
                    <h1 className="font-bold text-4xl text-primary text-center max-2xl:text-3xl">Beneficios <span className="text-secondary underline">a tu medida</span></h1>
