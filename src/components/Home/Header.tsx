    ...
    return (
        ...
        <div className="w-full h-auto">
            <div className="flex relative flex-col w-full h-full bg-gradient-to-r from-black/60 to-black/60">
                ...
                <div className="grid grid-cols-2 max-lg:grid-cols-1 max-lg:mx-5 2xl:max-w-7xl max-w-6xl lg:w-full mx-auto py-40 gap-20 ">
                    <Form />
                    <div className="flex flex-col justify-center text-white gap-3">
                        ...
                        <h1 className="text-md">Administración de Propiedades</h1>
                    </div>
                </div>
            </div>
        </div>
