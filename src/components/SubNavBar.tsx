    ...
    return (
        <>
            <nav className="bg-lightGray text-primary font-titilium sticky top-0 z-20 ">
                <div className="2xl:max-w-7xl max-w-5xl max-lg:mx-5 m-auto py-2 text-sm max-lg:text-xs flex justify-between items-center max-lg:items-start max-lg:gap-3">
